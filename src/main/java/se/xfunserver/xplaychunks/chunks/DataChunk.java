...
public class DataChunk {
    ...
    /** Whether TNT can explode in this chink if TNT is disabled in the config. */
    // Assignment because I'm not sure if GSON will handle it?
    @SuppressWarnings("UnusedAssignment")
    public boolean tnt = true;

    /**
     * Creates an instance of the chunk data that links to a chunk's position and the owning player.
     *
